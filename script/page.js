...
Q = QTemp, Q.sort(function() {
    ...
    var r, t, n, e, o;
    return o = $(window), r = $("body"), e = $("todo"), t = $("#keyin"), n = $("#report td"), 
    r.on("touchstart, mousedown, keydown", function(e) {
        var o;
        return e.preventDefault(), $(r).hasClass("report") ? ($(".num", t).text("?"), $(r).removeClass("report"), 
        1 > Q.length ? location.reload() : void 0) : (o = Q.rand(), o ? $(n).text(o) : $(n).text("ERROR"), 
        $(r).addClass("report"));
    });
});