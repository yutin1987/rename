...
array.prototype.rand = function() {
    var t;
    return t = Math.floor(Math.random() * this.length), this.splice(t, 1)[0];
}, Q.sort(function() {
    return .5 - Math.random();
}), $(function() {
    var t, r, n, o, e;
    return e = $(window), t = $("body"), o = $("todo"), r = $("#keyin"), n = $("#report td"), 
    t.on("touchstart, mousedown, keydown", function(o) {
        var e;
        return o.preventDefault(), $(t).hasClass("report") ? ($(".num", r).text("?"), $(t).removeClass("report"), 
        1 > Q.length ? location.reload() : void 0) : (e = Q.rand(), e ? $(n).text(e) : $(n).text("ERROR"), 
        $(t).addClass("report"));
    });
});